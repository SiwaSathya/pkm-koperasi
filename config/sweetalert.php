...
return [
    ...
    */
    ...
    'confirm_periode_confirm_button_text' => env('SWEET_ALERT_CONFIRM_PERIODE_CONFIRM_BUTTON_TEXT', 'Iya, Akhiri Sekarang'),
    'confirm_periode_confirm_button_color' => env('SWEET_ALERT_CONFIRM_PERIODE_CONFIRM_BUTTON_COLOR'),
    'confirm_periode_cancel_button_color' => env('SWEET_ALERT_CONFIRM_PERIODE_CANCEL_BUTTON_COLOR', '#d33'),
    'confirm_periode_cancel_button_text' => env('SWEET_ALERT_CONFIRM_PERIODE_CANCEL_BUTTON_TEXT', 'Cancel'),
    'confirm_periode_show_cancel_button' => env('SWEET_ALERT_CONFIRM_PERIODE_SHOW_CANCEL_BUTTON', true),
    'confirm_periode_show_close_button' => env('SWEET_ALERT_CONFIRM_PERIODE_SHOW_CLOSE_BUTTON', false),
    'confirm_periode_icon' => env('SWEET_ALERT_CONFIRM_PERIODE_ICON', 'warning'),
    'confirm_periode_show_loader_on_confirm' => env('SWEET_ALERT_CONFIRM_PERIODE_SHOW_LOADER_ON_CONFIRM', true),
