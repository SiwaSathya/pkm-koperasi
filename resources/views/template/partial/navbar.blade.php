<div class="navbar navbar-inverse bg-indigo">
		<div class="navbar-header">
			<a class="navbar-brand" href="index.html"><img src={{asset("asset/assets/images/logo_light.png")}} alt=""></a>
					...
					<li class="dropdown">
						...
						<div class="dropdown-menu dropdown-content width-350">
							...
							<ul class="media-list dropdown-content-body">
								<li class="media">
									<div class="media-left">
										<img src={{asset("asset/assets/images/placeholder.jpg")}} class="img-circle img-sm" alt="">
								...
								<li class="media">
									<div class="media-left"><img src={{asset("asset/assets/images/placeholder.jpg")}} class="img-circle img-sm" alt=""></div>
									<div class="media-body">
										<a href="#" class="media-heading">
